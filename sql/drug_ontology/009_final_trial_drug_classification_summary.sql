...
-- physical line per trial row and remains spreadsheet-safe. Excel has a
...
SELECT
    ...
    CASE
        WHEN length(regexp_replace(COALESCE(final_raw.intervention_types, ''), E'[\\r\\n\\t]+', ' ', 'g')) > 30000
            THEN left(regexp_replace(COALESCE(final_raw.intervention_types, ''), E'[\\r\\n\\t]+', ' ', 'g'), 29982) || ' ... [TRUNCATED]'
        ELSE regexp_replace(COALESCE(final_raw.intervention_types, ''), E'[\\r\\n\\t]+', ' ', 'g')
    END AS intervention_types,
    CASE
        WHEN length(regexp_replace(COALESCE(final_raw.intervention_names, ''), E'[\\r\\n\\t]+', ' ', 'g')) > 30000
            THEN left(regexp_replace(COALESCE(final_raw.intervention_names, ''), E'[\\r\\n\\t]+', ' ', 'g'), 29982) || ' ... [TRUNCATED]'
        ELSE regexp_replace(COALESCE(final_raw.intervention_names, ''), E'[\\r\\n\\t]+', ' ', 'g')
    END AS intervention_names,
    CASE
    ...
    CASE
        WHEN length(regexp_replace(COALESCE(final_raw.intervention_index_name_pairs, ''), E'[\\r\\n\\t]+', ' ', 'g')) > 30000
            THEN left(regexp_replace(COALESCE(final_raw.intervention_index_name_pairs, ''), E'[\\r\\n\\t]+', ' ', 'g'), 29982) || ' ... [TRUNCATED]'
        ELSE regexp_replace(COALESCE(final_raw.intervention_index_name_pairs, ''), E'[\\r\\n\\t]+', ' ', 'g')
    END AS intervention_index_name_pairs,
