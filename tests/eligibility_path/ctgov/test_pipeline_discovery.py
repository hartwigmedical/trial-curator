...
def test_trial_resource_discovery_uses_processed_trial_level_defaults(tmp_path: Path):
    ...
    write(data_dir / "exports/intermediates/ctgov/cancer_type/04a_cancer_type_trial_level.tsv")
    write(data_dir / "exports/intermediates/ctgov/gene_alteration/04a_gene_alteration_trial_level.tsv")
    write(data_dir / "exports/intermediates/ctgov/molecular_signature/03a_molecular_signature_trial_level.tsv")
...
def test_cohort_resource_discovery_uses_processed_cohort_level_defaults(tmp_path: Path):
    ...
    seed_curated_file(tmp_path / "data")
    seed_base_trials(tmp_path / "data")
    write(data_dir / "exports/intermediates/ctgov/cancer_type/04b_cancer_type_cohort_level.tsv")
    write(data_dir / "exports/intermediates/ctgov/gene_alteration/04b_gene_alteration_cohort_level.tsv")
    write(data_dir / "exports/intermediates/ctgov/molecular_signature/03b_molecular_signature_cohort_level.tsv")
