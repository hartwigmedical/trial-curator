...
from aus_trial_universe.core import paths as _paths   # noqa: E402
...
def _export_demo(ids: list[str], *, log: logging.Logger) -> int:
    ...
    from aus_trial_universe import export as _export
    from aus_trial_universe import trial_info as _ti
...
def main(argv: list[str] | None = None) -> int:
    ...
    from aus_trial_universe import run as _run
    from aus_trial_universe.tasks.drug_utility import build as _drug
