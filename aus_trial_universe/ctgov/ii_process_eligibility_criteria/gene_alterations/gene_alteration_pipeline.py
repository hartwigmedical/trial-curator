...
from aus_trial_universe.ctgov.ii_process_eligibility_criteria.gene_alterations.mapping.generate_gene_alteration_mapping import (
    map_row_to_args,
...
from aus_trial_universe.ctgov.ii_process_eligibility_criteria.gene_alterations.mapping.gene_alteration_mapping_corrections import (
...
def _polarity_from_rule_and_not(
    *,
    ...
    Therefore criterion is exclusive exactly when rule_exclude XOR under_not_criterion.
    """
