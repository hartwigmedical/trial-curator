...
from aus_trial_universe.ctgov.ii_process_eligibility_criteria.molecular_signature.mapping.molecular_signature_mapping import (
    build_molecular_signature_map,
)
from aus_trial_universe.ctgov.ii_process_eligibility_criteria.molecular_signature.mapping.molecular_signature_overwrite import (
...
DEFAULT_MOLECULAR_SIGNATURE_RESOURCE_SUBDIR = Path("resources/molecular_signature")
DEFAULT_PROCESSED_SUBDIR = Path("processed/molecular_signature")
...
def discover_pipeline_inputs(
    *,
    ...
    resolved_molecular_signature_resource_dir = (
        ...
        else resolved_eligibility_data_dir / DEFAULT_MOLECULAR_SIGNATURE_RESOURCE_SUBDIR
    )
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Defaults to eligibility_data_dir/resources/molecular_signature."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Defaults to eligibility_data_dir/processed/molecular_signature."
        ),
    )
    parser.add_argument(
        "--output_format",
