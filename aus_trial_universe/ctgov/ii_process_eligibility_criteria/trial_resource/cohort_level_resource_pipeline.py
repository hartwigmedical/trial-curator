...
from aus_trial_universe.ctgov.ii_process_eligibility_criteria.trial_resource.trial_level_resource_pipeline import (
...
DEFAULT_CURATED_DIR = Path("trials/original_curations")

DEFAULT_CANCER_TYPE_FILE = Path("processed/cancer_type/05_cohort_level_cancer_type.tsv")
DEFAULT_GENE_ALTERATION_FILE = Path("processed/gene_alteration/05_cohort_level_gene_alteration.tsv")
...
def discover_pipeline_inputs(
    *,
    ...
    resolved_curated_dir = _resolve_path(
        curated_dir if curated_dir is not None else eligibility_dir / DEFAULT_CURATED_DIR,
        repo_root,
    )
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "eligibility_data_dir/trials/original_curations."
        ),
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "eligibility_data_dir/exports/cohort_resource_<ddmmyyyy>.tsv."
        ),
    )
