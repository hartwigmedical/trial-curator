...
from aus_trial_universe.ctgov.eligibility.ii_process_eligibility_criteria.gene_alterations.mapping.gene_alteration_manual_filter import (
...
from aus_trial_universe.ctgov.eligibility.ii_process_eligibility_criteria.gene_alterations.mapping.gene_alteration_mapping import (
    build_gene_alteration_map,
)
from aus_trial_universe.ctgov.eligibility.ii_process_eligibility_criteria.gene_alterations.mapping.gene_alteration_mapping_corrections import (
    apply_mapping_corrections,
)
from aus_trial_universe.ctgov.eligibility.ii_process_eligibility_criteria.gene_alterations.mapping.gene_alteration_overwrite import (
...
SUPPORTED_RESOURCE_SUFFIXES: Set[str] = {".csv", ".tsv", ".xlsx", ".xls"}
...
DEFAULT_GENE_ALTERATION_RESOURCE_SUBDIR = Path("resources/gene_alteration")
DEFAULT_PROCESSED_SUBDIR = Path("processed/gene_alteration")
...
def _find_best_file(
    ...
    *,
    ...
    allowed_suffixes: Set[str] = SUPPORTED_RESOURCE_SUFFIXES,
    recursive: bool = False,
    label: str,
) -> Path:
    matches = [
...
def build_generated_mapping_resource(
    *,
    ...
    The generated resource is written to processed/gene_alteration and is the
    version used by the rest of the production pipeline.
...
def build_mapped_criteria_table(
    *,
    ...
    py_files = list(_iter_input_py_files(curated_dir))
...
def discover_pipeline_inputs(
    *,
    ...
    resolved_gene_alteration_resource_dir = (
        ...
        else resolved_eligibility_data_dir / DEFAULT_GENE_ALTERATION_RESOURCE_SUBDIR
    )
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "eligibility_data_dir/resources/gene_alteration."
        ),
    )
    parser.add_argument(
