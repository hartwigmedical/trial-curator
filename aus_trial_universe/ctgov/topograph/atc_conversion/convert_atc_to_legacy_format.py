#!/usr/bin/env python3
"""
Convert the newer WHO ATC/DDD CSV export into the legacy ATC tree TSV format.
...
Usage:
    ...
    python convert_atc_to_legacy_format.py \
        WHO.ATC-DDD.2026-04-25.csv \
        -o atc_tree_2026_legacy.tsv
"""
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "e.g. data/ctgov/drug_ontology/raw/ATC/version_25042026"
        ),
    )
    parser.add_argument(
        "--output_file",
