...
The RxNorm and ATC logic is delegated to the existing project modules:
    ...
    aus_trial_universe.ctgov.drug_ontology.rxnorm.matcher
    aus_trial_universe.ctgov.drug_ontology.classification.atc.ingredient_to_atc
...
DEFAULT_CTGOV_UNIQUE_DRUGS = Path("data/ctgov/drug_ontology/processed/ctgov_unique_drugs.tsv")
DEFAULT_TOPOGRAPH_UNIQUE_DRUGS = Path("data/topograph_hartwig_version/processed/topograph_unique_drugs.tsv")
