...
def default_output_dir_for_input(input_json: Path) -> Path:
    ...
    if "raw_inputs" in input_parent.parts:
        ...
        source_version = Path(*input_parent.parts[raw_inputs_index + 1 :])
        return root / "processed_inputs" / "analysis" / source_version
    if input_parent.name == "raw":
        return input_parent.parent / "processed_inputs" / "analysis"
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Output directory. Defaults to ../processed_inputs/analysis when the input is under a raw_inputs/ directory; "
