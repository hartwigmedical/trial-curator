...
drug orphaned by a deletion is reconciled in a SEPARATE, user-reviewed step. Dry-run by default.
  ...
  python -m aus_trial_universe.tasks.drug_utility.migrate_trial_arms            # dry-run + report
  python -m aus_trial_universe.tasks.drug_utility.migrate_trial_arms --apply    # also rewrite the TSV
"""
...
from aus_trial_universe.tasks.drug_utility.schema import TRIAL_TO_INTERVENTION_COLUMNS
