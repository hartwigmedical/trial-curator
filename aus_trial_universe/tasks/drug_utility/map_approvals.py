...
from aus_trial_universe.core.logfmt import line, stage
...
def write_mapped_approvals(store: DrugRefStore, joined_dir: Path) -> Path:
    ...
    from aus_trial_universe.core.paths import MAPPED_APPROVALS_FILE
...
def _drug_joined_dir() -> Path:
    ...
    from aus_trial_universe.core.paths import JOINED_DRUG, JOINED_ROOT
