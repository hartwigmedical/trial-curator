...
from aus_trial_universe.core.paths import CURRENT_VERSION, TRIAL_INFO_FILE, TRIAL_INFO_ROOT, current_version_dir
...
def anzctr_trial_info(row: dict) -> TrialInfo | None:
    from aus_trial_universe.tasks.eligibility.extraction.loaders import _display_actrn
...
def build_all_trial_info() -> dict[str, TrialInfo]:
    ...
    from aus_trial_universe.tasks.eligibility.extraction.loaders import _anzctr_rows, _ctgov_records
