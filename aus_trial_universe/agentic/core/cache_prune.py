...
Usage:
    python -m aus_trial_universe.agentic.core.cache_prune            # dry-run report
    python -m aus_trial_universe.agentic.core.cache_prune --apply    # delete stale
    python -m aus_trial_universe.agentic.core.cache_prune --apply --purge-unknown
"""
...
from aus_trial_universe.agentic.core.client import read_cache_meta
