...
Five 3NF tables, built once per unique drug and reused across the whole universe:
  ...
  drug_ref                   canonical_id -> intrinsic facts (class, modality, targets, ATC, POTTR, FDA/EMA)
  drug_target                (canonical_id, target, action) -> the mechanism as (target, action) pairs
  drug_indication            (canonical_id, indication) -> TGA/PBS approval (indication-specific)
