"""Dated-file / version-dir selection utilities.

COPIED (near-verbatim) from aus_trial_universe/eligibility_path/shared/utils/pipeline_io.py.
The eligibility path will be removed, so the agentic package owns its own copy rather
than importing it (see the "copy, don't import from eligibility_path" rule). Keep changes
minimal so this stays a faithful copy of the proven dated-file-selection standard.
"""
