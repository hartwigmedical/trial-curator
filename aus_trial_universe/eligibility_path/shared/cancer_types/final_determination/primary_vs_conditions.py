...
def run_combined_workflow(
    ...
    for py_path in iter_curated_py_files(curated_dir, trial_id_prefix="NCT"):
        n_files += 1
        try:
            rows.extend(
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        help=(
            "OncoTree CSV used by "
            "aus_trial_universe.eligibility_path.shared.oncotree.traverse_oncotree.OncoTree"
        ),
    )
    parser.add_argument(
