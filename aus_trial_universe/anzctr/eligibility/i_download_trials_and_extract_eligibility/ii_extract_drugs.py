...
DEFAULT_INPUT_CSV = Path("data/anzctr/eligibility/trials/anzctr_field_extractions.csv")
DEFAULT_OUTPUT_CSV = Path(
    "data/anzctr/eligibility/trials/anzctr_field_extractions_w_drugs.csv"
)
DEFAULT_RXNORM_RRF_DIR = Path(
    "data/ctgov/drug_ontology/raw_inputs/RxNorm/version_03022026"
)
...
def extract_drugs_to_csv(
    ...
    *,
    ...
    logger.info("Loading ANZCTR field extractions from %s", input_csv)
