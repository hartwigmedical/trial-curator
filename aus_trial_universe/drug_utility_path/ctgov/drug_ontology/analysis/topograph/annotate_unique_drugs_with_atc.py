...
The RxNorm and ATC logic is delegated to the existing project modules:
    ...
    aus_trial_universe.eligibility_path.ctgov.drug_ontology.identity.rxnorm.matcher
    aus_trial_universe.eligibility_path.ctgov.drug_ontology.sources.atc.ingredient_to_atc
...
from aus_trial_universe.drug_utility_path.ctgov.drug_ontology.shared.text import normalize_key as normalise_key
